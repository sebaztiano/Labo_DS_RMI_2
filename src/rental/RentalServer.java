...
public class RentalServer {
	...
	NumberFormatException, IOException {
		...
		CarRentalCompany company2 = new CarRentalCompany(data2.name, data2.regions, data2.cars);
	
		try{
			ISessionHandler stub = (ISessionHandler) UnicastRemoteObject.exportObject(sessionHandler,0);
